...
function endTest(){
    ...
    if(i>10){
        if(marcador>=91){
            ...
            giveAdvice(B,'Acude a cualquiera de los centros de Bienestar Respiratorio:','tel.svg',false);
        }else if(marcador>0){
            giveAdvice(A,'Informate al:','tel.svg',false);
        }else{
            giveAdvice('No presentas algún síntoma','Sigue cuidandote','tel.svg', false);
        }
    }
}
